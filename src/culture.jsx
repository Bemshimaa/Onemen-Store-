...
export default function Culture (){
    return(
        <section className="h-[350px] bg-black text-white flex flex-col gap-2 items-center justify-center relative">
            ...
            <p className='md:text-[1rem] lg:text-[1.5rem] scale-[150%]'>Onemen: One of None</p>
            <Button className="my-2 py-1 px-2 md:py-3 md:px-4 lg:py-2 lg:px-3 lg:text-[1rem] scale-[150%] cursor-pointer" variant ="white">Our Story</Button>
        </section>
    );
}