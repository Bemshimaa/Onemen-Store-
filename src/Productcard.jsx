...
export default function Card({ image, name, price, id }) {
  return (
    <div className="card px-4 py-8 border border-black-500">
      <Link to={`/Products/${id}`}><img className="md:mb-4 mb-2 border border-black-500 aspect-square" src={image} alt={name} /></Link>
